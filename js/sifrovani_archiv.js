...
function typeOfCipherAbout(cipher) {
  if (cipher == "morseCode") {
    ...
    document.querySelector("#cipherAboutInformation").innerHTML =
      "<h1>Automatická dešifrace</h1><p>Princip dešifrování je založen na slovníku složeného z českých slov. Spolehlivost automatického překladu je poměrně malá, a nedokáže prozatím moc efektivně šifru dešifrovat.</p>";
  }
}
...
function morseCode(input, length) {
  ...
  for (let i = 0; i < length; i++) {
    ...
    if (letter == "c" && letterCh == "h") {
      ...
      i++;
    } else if (letter == "a") letter = dot + comma;
    else if (letter == "b") letter = comma + dot + dot + dot;
    else if (letter == "c") letter = comma + dot + comma + dot;
    else if (letter == "d") letter = comma + dot + dot;
    else if (letter == "e") letter = dot;
    else if (letter == "f") letter = dot + dot + comma + dot;
    else if (letter == "g") letter = comma + comma + dot;
    else if (letter == "h") letter = dot + dot + dot + dot;
    else if (letter == "i") letter = dot + dot;
    else if (letter == "j") letter = dot + comma + comma + comma;
    else if (letter == "k") letter = comma + dot + comma;
    else if (letter == "l") letter = dot + comma + dot + dot;
    else if (letter == "m") letter = comma + comma;
    else if (letter == "n") letter = comma + dot;
    else if (letter == "o") letter = comma + comma + comma;
    else if (letter == "p") letter = comma + dot + dot + comma;
    else if (letter == "q") letter = comma + comma + dot + comma;
    else if (letter == "r") letter = dot + comma + dot;
    else if (letter == "s") letter = dot + dot + dot;
    else if (letter == "t") letter = comma;
    else if (letter == "u") letter = dot + dot + comma;
    else if (letter == "v") letter = dot + dot + dot + comma;
    else if (letter == "w") letter = dot + comma + comma;
    else if (letter == "x") letter = comma + dot + dot + comma;
    else if (letter == "y") letter = comma + dot + comma + comma;
    else if (letter == "z") letter = comma + comma + dot + dot;
    else if (letter == "1") letter = dot + comma + comma + comma + comma;
    else if (letter == "2") letter = dot + dot + comma + comma + comma;
    else if (letter == "3") letter = dot + dot + dot + comma + comma;
    else if (letter == "4") letter = dot + dot + dot + dot + comma;
    else if (letter == "5") letter = dot + dot + dot + dot + dot;
    else if (letter == "6") letter = comma + dot + dot + dot + dot;
    else if (letter == "7") letter = comma + comma + dot + dot + dot;
    else if (letter == "8") letter = comma + comma + comma + dot + dot;
    else if (letter == "9") letter = comma + comma + comma + comma + dot;
    else if (letter == "0") letter = comma + comma + comma + comma + comma;
    else if (letter == "," || letter == ".") letter = slash + slash;
    else if (letter == " ") letter = slash;
    else
...
function phoneCipher(input, length) {
  ...
  for (i = 0; i < length; i++) {
    ...
    else if (letter == "b") letter = "22";
    else if (letter == "c") letter = "222";
    else if (letter == "d") letter = "3";
    else if (letter == "e") letter = "33";
    else if (letter == "f") letter = "333";
    else if (letter == "g") letter = "4";
    else if (letter == "h") letter = "44";
    else if (letter == "i") letter = "444";
    else if (letter == "j") letter = "5";
    else if (letter == "k") letter = "55";
    else if (letter == "l") letter = "555";
    else if (letter == "m") letter = "6";
    else if (letter == "n") letter = "66";
    else if (letter == "o") letter = "666";
    else if (letter == "p") letter = "7";
    else if (letter == "q") letter = "77";
    else if (letter == "r") letter = "777";
    else if (letter == "s") letter = "777";
    else if (letter == "t") letter = "8";
    else if (letter == "u") letter = "88";
    else if (letter == "v") letter = "888";
    else if (letter == "w") letter = "9";
    else if (letter == "x") letter = "99";
    else if (letter == "y") letter = "999";
    else if (letter == "z") letter = "9999";
    else
      letter = letter.replace(
        letter,
        "<span class='differentLetter'>" + letter + "</span>"
...
function morseCodeDecryption(input, length) {
  ...
  for (i = 0; i < length; i++) {
    ...
    if (character == dot || character == comma || character == slash) {
      ...
      if (i > 0) {
        if (
          ((nextCharacter == dot || nextCharacter == comma) &&
            character == slash) ||
